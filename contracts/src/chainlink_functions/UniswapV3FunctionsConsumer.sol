 ...
 */
contract UniV3FunctionsConsumer is FunctionsClient, ConfirmedOwner {
    ...
    string constant public DAO = "uniswapgovernance.eth";
    ...
    mapping(bytes32 requestId => address user) public requestInfo;
    ...
    function sendRequest(
        ...
        // Cache request info
        requestInfo[s_lastRequestId] = _toAddress(args[0]);
    ...
    function fulfillRequest(
        ...
        if (_checkIsBytesZero(err)) {
            address user = requestInfo[requestId];
