...
contract Comptroller is ComptrollerV7Storage, ComptrollerInterface, ComptrollerErrorReporter, ExponentialNoError {
    ...
    function getHypotheticalAccountLiquidityInternal(
        ...
        CToken cTokenModify,
        uint redeemTokens,
        uint borrowAmount) virtual internal view returns (Error, uint, uint) {
    ...
    /**
      ...
      */
    function _setPriceOracle(PriceOracle newOracle) override public returns (uint) {
    ...
    /**
      ...
      */
    function _supportMarket(CToken cToken) override external returns (uint) {
        if (msg.sender != admin) {
