...
import "../interfaces/ILiquidityEvents.sol";
...
contract LiquidityProvidersUnitTest is BaseTest, ILiquidityEvents {
    ShylockLiquidity liquidityProviders;
    ERC20Mock daiToken;
    ...
    function setUp() public {
        liquidityProviders = new ShylockLiquidity();
    ...
    function testCannotWithdrawEth_withdraw_more_than_account_has() public {
        ...
        // console balance of 0x0000000000000000000000000000000000000001
        hevm.deal(address(0x0000000000000000000000000000000000000001),1);
        Console.log(address(0x0000000000000000000000000000000000000001).balance);
